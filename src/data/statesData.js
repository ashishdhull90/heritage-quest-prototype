  ...
  locations: [
...

    {
      ...
      inscriptionFragments: [
        ...
        {
          id: 'frag_water',
          title: 'Ranisar Lake & Water Inscription',
          subtitle: 'Desert Water Engineering & Natural Basin',
          order: 3,
          area: 'Deep Cistern Terrace (Ranisar Lake)',
          x: 1880,
          y: 1250,
          shortTag: 'Ranisar Lake',
          ancientScript: 'रानीसर पद्मसर जल संचयन सूर्य वंश ध्वज',
          transcription: 'Ranisar and Padamsar reservoirs capture every drop of monsoon rain to sustain the Sun Citadel.',
          description: 'Constructed at the foot of Mehrangarh Fort, Ranisar Lake harvested natural rainfall runoff from the elevated rocky plateau, securing vital water for the fortress through dry seasons.',
          vikramQuote: 'Water was life in the Thar. By sculpting stone channels into the volcanic rock, Mehrangarh directed rainwater into Ranisar Lake, sustaining the fortress through years of drought.',
          discoveryXP: 25
        }
      ],
      highlights: [
